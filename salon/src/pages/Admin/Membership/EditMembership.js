...
const EditMembership = (props) => {
  ...
  const [membershipInfo, setMembershipInfo] = useState(editmembership);
  useEffect(() => {
  ...
  var initialFormState = {
    membershipid: editmembership ? editmembership._id : '',
    planName: editmembership ? editmembership.planName : '',
    staffLimit: editmembership ? editmembership.staffLimit : 0,
    commisionPercent: editmembership ? editmembership.commisionPercent : 0,
    planType: editmembership ? editmembership.planType : 'Both',
    monthlyPrice: editmembership ? editmembership.monthlyPrice : 0,
    yearlyPrice: editmembership ? editmembership.yearlyPrice : 0,
    bookingWidget: editmembership ? editmembership.bookingWidget : false,
    subDomain: editmembership ? editmembership.subDomain : true,
    uniqueDomain: editmembership ? editmembership.uniqueDomain : true,
    discount: editmembership ? editmembership.discount : 0,
  }
