    ...
    <section className="mb100 mobMb30">
      <Container>
        <section className="mb80 mobMb30">
          ...
          <p className="fs16 colorWhite width50 mobWidth100 tabWidth100 tabLgWidth100">
        ...
        <section>
          <div className="mb80 mobMb15 text-center">
            <h3 className="fs60 mobMb10 mb30 mobFs45 tabFs60">
              <Link to={props.props.path} className="colorWhite">
                Next Project
              </Link>
            </h3>
            <div>
              <Link to={props.props.path}>{Svg.arrowDiagnalWhite}</Link>
            </div>
          </div>
        </section>
      </Container>
